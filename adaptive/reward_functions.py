...
#
#         # if error = 10^m * tol, then reward = -m
#         return 0.6 * np.log10(self.error_tol / error)



# r = Reward()
#
# f = r.log_map((0.001, 0.1), (0.48, 2))
#
# for x in [0.001, 0.005, 0.01, 0.05, 0.1, 0.25, 0.27, 0.29, 0.31, 0.33, 0.36, 0.39, 0.42, 0.45, 0.48]:
#     print(x, f(x))